...
class Arduino(object):
    def __init__(self, port=None, baudrate=115200):
        """
        Args:
            port (str, optional): Device name or port number or None.
        ...
        # this flag denoting whether a command is having been completed
    ...
    def write(self, keys, end_line=False):
    ...
    def move(self, dest_x, dest_y):
        ...
        self.__write_short(dest_x + BYTES_MODIFIER)
        self.__write_short(dest_y + BYTES_MODIFIER)
